...
module.exports = function(server, config, log) {
    ...
    var _validateMessage = P.method(function(schema, msg) {
        if(schema) {
            return P.promisify(Joi.validate, Joi)(msg, schema, { allowUnknown: true, stripUnknown: true });
        }
        else {
            return msg;
        }
                    ...
                    return _validateMessage(service.schema, msg).then(function(msg) {
                        return P.method(service.callback)(msg).then(function(resp) {
                            ...
                            if(service.responseSchema) {
                                return Joi.validate(resp, service.responseSchema, { allowUnknown: true, stripUnknown: true });
                            }
                            else {
                                return resp;
                            }
